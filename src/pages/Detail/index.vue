                ...
                <div class="InfoWrap">
                    ...
                    <div class="choose">
                        ...
                        <div class="cartWrap">
                            ...
                            <div class="add">
                                <!-- 这里加入购物车操作,在进行路由跳转之前,先发一次请求,把商品详情通过请求的形式通知服务器,服务器进行响应的存储 -->
    ...
    methods: {
        ...
        async addshopcar() {
            ...
            try {
                ...
                // 成功后进行路由的跳转->addCartSuccess路由
                // 在路由跳转的时候把产品信息一起带过去
                this.$router.push({
                    name: "addcartsuccess",
                    query: { skuNum: this.skuNum },
                });
                // 一些简单的数据,可以通过query形式给路由组件传递
                // 产品数据信息[较为复杂],则通过会话存储的形式传递
                // 本地/会话存储 不可以存对象,一般是存字符串
