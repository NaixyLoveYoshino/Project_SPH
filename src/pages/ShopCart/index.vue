<template>
    <div class="cart">
            ...
            <div class="cart-body">
                <ul class="cart-list" v-for="(cart) in cartInfoList" :key="cart.id">
                    ...
                    <li class="cart-list-con7">
                        <a class="sindelet" @click="delectCartById(cart)">删除</a>
                        <br />
                        <a href="#none">移到收藏</a>
                    </li>
                </ul>
        ...
        <div class="cart-tool">
            ...
            <div class="option">
                <a @click="delectAllCheckedCart">删除选中的商品</a>
...
export default {
    ...
    methods: {
        ...
        handler: throttle(async function (type, disNum, cart) {
            // type:区分元素
            // disNum:形参:+(变化量1) -(变化量-1) input最终的个数(非变化量)
            // cart:区分是哪一个商品
            // 向服务器发请求,修改数量
            switch (type) {
                case "add":
